...
def Initialisations():
    ...
    menuWindow = GUI.Window(
        gameTitle, framerate, bg="Images/backgroundsprites/TitleBG.bmp"
    )
    gameWindow = GUI.Window(
        gameTitle, framerate, bg="Images/backgroundsprites/Background.bmp"
    )

    # dictionary containing instances of custom button class, located on menu window
    menuLayersDict = {
        "Invasions": GUI.Layer(
            [menuWindow.width / 2, menuWindow.height / 4],
            menuWindow,
            text="Invasions",
        ...
        "Start": GUI.Layer(
            [menuWindow.width / 3, 2 * menuWindow.height / 3],
            menuWindow,
            text="Start",
            textFontLocation="Fonts/gasalt-regular.ttf",
            textFontSize=36,
            textColour=white,
            textHoverClr=(102, 255, 71),
            is_button=True,
        ),
        "Tutorial": GUI.Layer(
            [menuWindow.width / 2, 2 * menuWindow.height / 3],
            menuWindow,
            text="Tutorial",
            textFontLocation="Fonts/gasalt-regular.ttf",
            textFontSize=36,
        ...
        "Quit": GUI.Layer(
            [2 * menuWindow.width / 3, 2 * menuWindow.height / 3],
            menuWindow,
            text="Quit",
            textFontLocation="Fonts/gasalt-regular.ttf",
            textFontSize=36,
        ...
        "homeLogo": GUI.Layer(
            [40, 40],
            menuWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/home.bmp"), (30, 30)
            ),
            is_button=False,
            is_active=True,
        ),
    ...
    gameLayersDict = {
        # settings
        "pauseLogo": GUI.Layer(
            [gameWindow.width - 35, 35],
            gameWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/pause.bmp"), (35, 35)
            ),
            is_button=True,
        ),
        "pauseText": GUI.Layer(
            [gameWindow.width / 2, 260],
            gameWindow,
            text="Settings",
            textFontLocation="Fonts/titlefont.ttf",
            textFontSize=35,
        ...
        "resumeLogo": GUI.Layer(
            [gameWindow.width / 2, 395],
            gameWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/play.bmp"), (30, 30)
            ),
            is_button=True,
            is_active=False,
        ),
        "quitLogo": GUI.Layer(
            [gameWindow.width / 2, 475],
            gameWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/quit.bmp"), (30, 30)
            ),
            is_button=True,
            is_active=False,
        ),
    ...
    tutorialLayersDict = {
        "skipLogo": GUI.Layer(
            [gameWindow.width - 75, gameWindow.height - 100],
            gameWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/skip.bmp"), (75, 75)
            ),
            is_button=True,
            is_active=True,
        ),
        "aimText": GUI.Layer(
            ...
            gameWindow,
            text="To win the game, don't let all the humans die and kill the invader",
            textFontLocation="Fonts/ferrum.ttf",
            textFontSize=35,
            textColour=white,
            is_active=True,
        ),
        "movementText": GUI.Layer(
            [gameWindow.width / 2, 250],
            gameWindow,
            text="Use arrow keys to move your character. Try it now!",
            textFontLocation="Fonts/ferrum.ttf",
            textFontSize=35,
            textColour=white,
            is_active=True,
        ...
        "shootText": GUI.Layer(
            [gameWindow.width / 2, 350],
            gameWindow,
            text="Press SPACE to shoot bullets. Give it a shot!",
            textFontLocation="Fonts/ferrum.ttf",
            textFontSize=35,
            textColour=white,
            is_active=False,
        ...
        "enemyText": GUI.Layer(
            [gameWindow.width / 2, 450],
            gameWindow,
            text="Watch out for the enemy as they come down and shoot at you. Use that chance to destroy the alien invader!",
            textFontLocation="Fonts/ferrum.ttf",
            textFontSize=33,
            textColour=white,
            is_active=False,
    ...
    endgameLayersDict = {
        "homeLogo": GUI.Layer(
            [45 * gameWindow.width / 100, 1 * gameWindow.height / 2],
            menuWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/home.bmp"), (30, 30)
            ),
        ...
        "Quit": GUI.Layer(
            [55 * gameWindow.width / 100, 1 * gameWindow.height / 2],
            menuWindow,
            renderedImage=pygame.transform.scale(
                pygame.image.load("Images/menusprites/quit.bmp"), (30, 30)
            ),
    ...
    plyr = Character(
        ...
        plyr_animList,
        5,
        "Images/playersprites/bullet/bullet.bmp",
        gameWindow,
    )
    enemy = Character(
        1 / 8,
        ...
        enemy_animList,
        50,
        "Images/enemysprites/bullet/enemybullet-1.png.bmp",
        gameWindow,
    )
