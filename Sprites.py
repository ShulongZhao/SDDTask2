...
class Character(pygame.sprite.Sprite):
    def __init__(
        self, scaleFactor, startingPos, speed, animsDirList, health, bulletImage, window
    ):
        ...
        self.rect.size = (
            int(self.rect.width * self.scaleFactor),
            int(self.rect.height * self.scaleFactor),
        )
